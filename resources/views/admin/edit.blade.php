...
<div class="section">
  <form action="{{ url('admin/update', $tampiledit->id) }}" method="POST" enctype="multipart/form-data">
    {!! csrf_field() !!}
    <div class="row">
      ...
      <div class="row">
        <div class="col s6">
            <img src="{{ asset('images/'.$tampiledit->gambar) }}" id="showgambar" style="max-width:400px;max-height:200px;float:left;" />
        </div>
    </div>
    <div class="row">
